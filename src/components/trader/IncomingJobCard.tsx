        ...
        {hasPhotos ? (
          ...
          <div className="relative flex items-center justify-center h-full bg-muted/20">
            ...
            <button
              ...
              disabled={photoRequested}
              className="absolute bottom-3 inset-x-4 flex items-center justify-center gap-1.5 rounded-xl px-3 py-2 text-[11px] font-bold active:opacity-80 disabled:opacity-50 bg-card border border-primary text-primary"
            >
